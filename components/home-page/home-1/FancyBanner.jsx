...
const FancyBanner = () => {
    const bannerData = [
        ...
        {
            title: "About Us",
            mainTitle: "Personal, Accessible Pediatric Care is Now Available in Avondale",
            description:
                ...
                {bannerData.map((data, index) => (
                    <div className="" key={index}>
                        <div className="row align-items-center ">
                            <div
                                className={`col-xl-7 col-lg-7 backgroundBlue order-lg-${data.illustrationPosition === "left" ? "first" : "last"
                                    }`}
                                data-aos={data.aos}
                            >
                            ...
                            <div
                                className={`col-xl-5 col-lg-5 col-md-5 m-auto order-lg-${data.illustrationPosition === "left" ? "last" : "first"
                                    }`}
                                data-aos={data.aos}
                            >
