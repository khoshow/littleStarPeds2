...
const PortfolioV1 = () => {
  const head = () => {
    const title = "Cold and FLu || Little Star Pediatrics";
    const metaDesc =
      "Beat the cold and flu season in Avondale, AZ together with our nurse practitioners! Regain your health today - schedule a visit now!";
    const websiteUrl = "https://littlestarpeds.com/";
    const cononicalURL = websiteUrl + "services/cold-and-flu";
    const websiteName = "Little Star Pediatrics";
    const imageUrl = websiteUrl + "images/myImages/cold.avif";
